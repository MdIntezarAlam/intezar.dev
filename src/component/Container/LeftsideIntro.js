...
const text =
  "Working as Frontend React js/ Next Js / React Native Developer in  a Product based Company and having the zeal to up-skill, being efficient & productive for the company & develop as well as diversifying my professional skill-set. Looking forward to working as a software developer in a Multinational Company.Frontend developer using modern technology such as React Js/ Next JS, Typescript,Bootstrap,Tailwind Css,Shadcn, Zustand, Redux or redux toolkit,Git,GitHub,Node Js,ExpressJs & MongoDB. I follow the best folder structure so that code will be more re-usable,scalable and flexibile. I mainly focus on code quality and performance."
